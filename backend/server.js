...
const mockBusinesses = [
  ...
  },
  {
    ...
    category: 'Instituições Religiosas',
...
app.get('/api/businesses', (req, res) => {
  ...
  // Simular filtro por localização (simplificado)
  if (latitude && longitude && radius) {
    // Em uma implementação real, calcularia a distância real
    console.log(`Filtro por localização: lat=${latitude}, lng=${longitude}, radius=${radius}m`);
  }
...
// Rota específica para busca de negócios
...
// Obter negócios por subcategoria
app.get('/api/businesses/subcategory/:subcategory', (req, res) => {
  const { subcategory } = req.params;
  
  // Filtrar negócios pela subcategoria
  const filteredBusinesses = mockBusinesses.filter(business => 
